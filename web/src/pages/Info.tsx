...
export default function Info() {
	...
	const showMessageBox = () => {
		os.showMessageBox("This is title", "This is message");
	};
		...
		<>
			<div className="flex flex-grow p-3 m-8px flex-col justify-between">
				<div className="">
					...
					<p>
						Framework version: <span className="font-bold">{NL_VERSION}</span>
					</p>
					<p>
						Client version: <span className="font-bold">{NL_CVERSION}</span>
					</p>
					<p>
						Mode: <span className="capitalize font-bold">{NL_MODE}</span>
					</p>
				</div>
				<div className="">
					<button
					...
					<button
						className="btn btn-lg btn-accent mb-2 mr-2"
